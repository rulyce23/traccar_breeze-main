...
?>
            <div class="inline-flex items-center space-x-4">
                ...
                <span><strong>User:</strong> <?php echo e($userName); ?></span> <!-- User Name -->
                <span><strong>Account:</strong> <?php echo e($accountName); ?></span> <!-- Account Name -->
                <span><strong>Account Type:</strong> <?php echo e($accountType); ?></span> <!-- Account Type -->
            </div>
            
            <!-- Search Form -->
            <form method="GET" action="<?php echo e(route('account.index')); ?>" class="flex flex-wrap gap-4 items-center">
           ...
           <br>
            <table id="userTable" class="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $userx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td><?php echo e($user->attributes->account_type); ?></td>
                            <td><?php echo e($user->attributes->user_name); ?></td>
                            <td><?php echo e($user->phone); ?></td>
                            <td>
                                <?php if(!empty($userDevices)): ?>
                                    <?php $__currentLoopData = $userDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($device->contact); ?><br>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($deviceCount); ?></td>
                            <td><?php echo e($user->disabled ? 'Nonactive' : 'Active'); ?></td>
                            <td class="px-4 py-2 flex gap-2">
                                <a href="#" onclick="openModals()"><i class="fa fa-edit text-blue-500 hover:text-blue-600"></i></a>
                                <a href="#" onclick="openModal(<?php echo e($user->id); ?>)">
                    <i class="fa fa-eye text-green-500 hover:text-green-600"></i>
                </a>
                <form action="<?php echo e(route('device.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this device?')" style="display: inline;">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white p-6 rounded-md shadow-lg w-11/12 sm:w-1/2 max-h-[80vh] overflow-y-auto">
        ...
        <form id="userForm" action="<?php echo e(route('account.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <div class="bg-white p-6 rounded-md shadow-lg w-11/12 sm:w-1/2 max-h-[80vh] overflow-y-auto">
        <h2 class="text-lg font-semibold mb-4" id="modalTitle">User Details</h2>
        <form id="userForm" action="<?php echo e(route('user.update', 'id')); ?>" method="POST">
...
function openModal(id) {
    ...
    const password = '<?php echo e(session("password")); ?>';
...
<?php /**PATH C:\xampp\htdocs\traccar_breeze-main\resources\views/master/account/index.blade.php ENDPATH**/ ?>