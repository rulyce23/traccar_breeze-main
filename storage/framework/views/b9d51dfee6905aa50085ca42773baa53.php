...
<?php $component->withAttributes([]); ?>
    <div class="w-[318px] fixed left-1/2 top-1/2 -ml-[159px] -mt-[185px] z-10">
        ...
        <form action="<?php echo e(route('login.store')); ?>" method="POST">
            <div class="pt-5">
                <img src="<?php echo e(asset('images/logo.png')); ?>" class="object-contain w-full" alt="">
            </div>
            <?php echo csrf_field(); ?>
            <div class="mb-5">
                <div class="relative">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\traccar_breeze-main\resources\views/auth/login.blade.php ENDPATH**/ ?>