                        ...
                        <div style="padding: 10px 13px 0">
                            <ul class="p-[10px] w-full bg-[#d5dced]  rounded space-y-3">
                                <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <li class="w-full">
                                        <button id="device" data-id="<?php echo e($item->id); ?>"
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-[2px] w-2/3">
                                                    <div <?php if($item->status == 'online'): ?> style="background-color:green"
                                                    <?php elseif($item->status == 'offline'): ?>
                                                    style="background-color:#dc7977"
                                                    <?php else: ?>
                                                    style="background-color:#666" <?php endif; ?>
...
<script src="<?php echo e(asset('leaflet/js/heremap.js')); ?>"></script>
<script>
    ...
    var markers = {};
    const token = JSON.parse('<?php echo json_encode($token); ?>');
...
// Updated function to handle API requests and errors
    ...
    function updateLocationDisplay(locationName) {
        ...
        var customIcon = L.divIcon({
            ...
            html: '<img style="width:30px !important" src="<?php echo e(asset('storage/icon/marker.png')); ?>" alt="">',
            iconSize: [24, 24]
        });
    ...
    var email = '<?php echo e(session("email")); ?>';  // Assuming you are using Blade templating
    var password = '<?php echo e(session("password")); ?>';
...
<?php /**PATH C:\xampp\htdocs\traccar_breeze-main\resources\views/master/monitor/index.blade.php ENDPATH**/ ?>